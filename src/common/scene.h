...
struct Material {
    ...
    float       blurred_reflection_size = 0;         // Reflection size
    float       num_blurred_samples = 0;                // Number of blurred reflection samples

    bool        tiling = false;       // tile the texture
    bool        bilinear_filter = false;     // use bilinear filtering
    bool        mipmap_filter = false;     // use mip-map to interpolate texture resolutions

    // Textures needed for mip mapping
    image3f*    mipmap_texture_1 = nullptr;
    image3f*    mipmap_texture_2 = nullptr;
    image3f*    mipmap_texture_3 = nullptr;
    image3f*    mipmap_texture_4 = nullptr;
    image3f*    mipmap_texture_5 = nullptr;
    image3f*    mipmap_texture_6 = nullptr;
    image3f*    mipmap_texture_7 = nullptr;
    image3f*    mipmap_texture_8 = nullptr;
    image3f*    mipmap_texture_9 = nullptr;
    image3f*    mipmap_texture_10 = nullptr;
...
struct Scene {
    ...
    int                 path_max_depth = 2;     // maximum path s
